...
horizontal_bar_chart <- bar_df %>%
  ...
  theme(axis.title.y = ggplot2::element_blank(),
        ...
        panel.grid.major.x = ggplot2::element_line(color = nice_cols("black_25")),
...
scatter_chart <- scatter_df %>%
  ...
  theme(panel.border = ggplot2::element_rect(color = nice_cols("black_100"),
                                             linewidth = 0.3,
                                             fill = NA),
        panel.grid.major.x = ggplot2::element_line(color = nice_cols("black_25"))) +
  # Add labels
...
pal <- colorRampPalette((c(nice_cols("black_25"), 
                           nice_cols("bold_teal_100"))))(5)       # Sequential palette
